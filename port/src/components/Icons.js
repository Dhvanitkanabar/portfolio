...
export const PostmanIcon = ({ className, ...rest }) => (
    ...
    >
        <path
            fill="currentColor"
            d="M23.116 11.332a.56.56 0 0 0-.54-.424h-1.32c-.104-5.35-4.49-9.638-9.873-9.638s-9.77 4.288-9.873 9.638h-1.32a.56.56 0 0 0-.54.424a.57.57 0 0 0 .144.576l1.32 1.32a.557.557 0 0 0 .792 0l1.32-1.32a.57.57 0 0 0 .144-.576a.56.56 0 0 0-.54-.424H1.61c.103-4.636 3.844-8.377 8.48-8.48v1.32c0 .308.252.56.56.56c.308 0 .56-.252.56-.56v-1.32c4.636.103 8.377 3.844 8.48 8.48h-1.258a.56.56 0 0 0-.54.424a.57.57 0 0 0 .144.576l1.32 1.32a.557.557 0 0 0 .792 0l1.32-1.32a.57.57 0 0 0 .144-.576M5.895 11.468c.103 2.84 2.14 5.253 4.86 5.864v-1.6c0-.308.252-.56.56-.56c.308 0 .56.252.56.56v1.6c2.72-.61 4.757-3.024 4.86-5.864h-10.84Z"
        />
        <path fill="currentColor" d="M11.315 22.016a10.975 10.975 0 0 1-10.309-7.144l1.246-.445a9.66 9.66 0 0 0 9.063 6.273a9.66 9.66 0 0 0 9.063-6.273l1.246.445a10.975 10.975 0 0 1-10.309 7.144Z"/>
    </svg>
);
...
export const FigmaIcon = ({ className, ...rest }) => (
    ...
    >
        <path
            fill="currentColor"
            d="M19 28.5c0-5.247 4.253-9.5 9.5-9.5S38 23.253 38 28.5 33.747 38 28.5 38 19 33.747 19 28.5M0 47.5C0 42.253 4.253 38 9.5 38S19 42.253 19 47.5 14.747 57 9.5 57 0 52.253 0 47.5M0 28.5C0 23.253 4.253 19 9.5 19S19 23.253 19 28.5 14.747 38 9.5 38 0 33.747 0 28.5M0 9.5C0 4.253 4.253 0 9.5 0S19 4.253 19 9.5 14.747 19 9.5 19 0 14.747 0 9.5m19 0c0-5.247 4.253-9.5 9.5-9.5S38 4.253 38 9.5 33.747 19 28.5 19 19 14.747 19 9.5"
        />
    </svg>
);
